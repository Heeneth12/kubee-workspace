...
@Component({
    selector: 'app-goods-receipt-adapter',
    standalone: true,
...
export class GoodsReceiptAdapterComponent {

    activeTab = signal<string>('list');
    isLoading = signal<boolean>(false);

    navigationTabs: TabItem[] = [
        { id: 'list', label: 'Goods Receipt', icon: FileText },
        { id: 'create', label: 'Create GRN', icon: FilePen },
        { id: 'edit', label: 'Edit GRN', icon: Pencil }
    ];
    ...
    constructor(
        ...
        this.router.events.subscribe((event) => {
            ...
            if (url.includes('/purchases/grn/create')) {
                this.activeTab.set('create');
            } else if (url.includes('/purchases/grn/edit')) {
