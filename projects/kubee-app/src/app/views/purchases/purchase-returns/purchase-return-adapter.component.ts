...
@Component({
    selector: 'app-purchase-return-adapter',
    standalone: true,
...
export class PurchaseReturnAdapterComponent {

    activeTab = signal<string>('list');
    isLoading = signal<boolean>(false);

    navigationTabs: TabItem[] = [
        { id: 'list', label: 'Purchase Return', icon: FileText },
        { id: 'create', label: 'Create PR', icon: FilePen },
        { id: 'edit', label: 'Edit PR', icon: Pencil }
    ];
    ...
    constructor(
        ...
        this.router.events.subscribe((event) => {
            ...
            if (url.includes('/purchases/return/create')) {
                this.activeTab.set('create');
            } else if (url.includes('/purchases/return/edit')) {
